...
Tower::Tower(ShaderProgram& shaderProgram): shaderProgram(shaderProgram), vao(0), vbo(0), ibo(0) {
  createObject();
}

void Tower::createObject() {
...
void Tower::draw(glm::mat4 projection, glm::mat4 view) {
  shaderProgram.use();
